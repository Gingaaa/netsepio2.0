  ...
  return (
    <>
      <div className="fo">
        ...
        <div>
          <h6 style={{ paddingLeft: "118px", paddingTop: "19px", fontSize:"1.3vw" }}>
            Lazarus Network Inc. <br /> 2209 SW 58th Way <br /> West Park,
            Florida 33023 <br /> +1 954 378 9548 <br />
          </h6>
          <h6 style={{ paddingLeft: "118px", paddingTop: "23px",  fontSize:"1.3vw" }}>
            hello@netsepio.com
          </h6>
        </div>

        <h5 style={{ textAlign: "center", marginTop: "53px", fontWeight:"bold", fontSize:"1.6vw" }}>
          2021-2022 © NetSepio
        </h5>
      </div>
      <div className="get">
        <h4 style={{ marginLeft: "97px", fontWeight: "bold", fontSize:"1.8vw" }}>Subscribe</h4>
        ...
        <div class="col-auto">
          <button
            ...
            style={{ marginTop: "23px", marginLeft: "110px", fontSize:"1.2vw" }}
          >
            Opt-in
          </button>
        </div>
        <p style={{ marginLeft: "-155px", fontSize:"1.3vw" }}>
          Latest news delivered right to your inbox! Your information will be
          kept confidential.
        </p>
      </div>
      <div className="con d-flex flex-row-reverse">
        <h4 style={{ fontWeight: "bold", fontSize:"1.8vw" }}>Connect</h4>
      </div>
