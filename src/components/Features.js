      ...
      <div>
        ...
        <div>
          <p className="fp">
            ...
            categorizing it into various categories and get rewards. This
            enables them to pre-emptively protect their online activities from
            advanced threats in a collaborative way with a decentralized and
            tamperproof process using blockchain technology. Having a security &
            privacy focused framework for online activities & Pseudo-anonymous
            Reputation based systems for online interactions.
          </p>
        </div>
        ...
        <div className="container">
          ...
          <p className="ffp">
            ...
            receives 3 warnings and ban a user if both conditions of a vote
            aren't met. <br />
          ...
          <p className="ffp">
            3. Admin - Manages the smart contract operations related to user
            voting <br />
